...
const seedMonstersBase: Monster[] = [
  {
    ...
    actions: ["Club: +2 to hit, 5 ft., 1d4 bludgeoning."],
    source: "SRD",
  ...
  },
  {
    ...
    senses: "Passive Perception 10",
    languages: "Any one language",
    traits: ["Dark Devotion: advantage on saves vs charmed or frightened."],
    actions: ["Scimitar: +3 to hit, 5 ft., 1d6+1 slashing."],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  ...
  },
  {
    ...
    traits: ["Spellcasting (cleric): spell save DC 12, +4 to hit."],
    actions: ["Club: +2 to hit, 5 ft., 1d4 bludgeoning."],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  {
    ...
    languages: "--",
    traits: ["Charge.", "Relentless (1/short rest)."],
    actions: ["Tusk: +3 to hit, 5 ft., 1d6+1 slashing."],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  {
    id: "mon-constrictor-snake",
    ...
    languages: "--",
    actions: [
      "Bite: +4 to hit, 5 ft., 1d6+2 piercing.",
      "Constrict: +4 to hit, 5 ft., 1d8+2 bludgeoning (grapple).",
    ],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  {
    ...
    actions: ["Talons: +3 to hit, 5 ft., 2d6+1 slashing."],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  {
    id: "mon-giant-poisonous-snake",
    ...
    senses: "Blindsight 10 ft., Passive Perception 10",
    languages: "--",
    actions: ["Bite: +6 to hit, 5 ft., 1d4+4 piercing plus poison."],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  {
  ...
  },
  {
    ...
    actions: [
      "Bite: +4 to hit, 5 ft., 1d6+2 piercing.",
      "Claw: +4 to hit, 5 ft., 1d4+2 slashing.",
    ],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  ...
  },
  {
    ...
    languages: "--",
    traits: ["Keen Smell.", "Swarm."],
    actions: ["Bites: +2 to hit, 5 ft., 4d6 piercing."],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  {
  ...
  },
  {
    ...
    languages: "--",
    traits: ["Amorphous.", "Corrode Metal.", "False Appearance."],
    actions: ["Pseudopod: +3 to hit, 5 ft., 1d6+1 bludgeoning plus 2d6 acid."],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  {
  ...
  },
  {
    ...
    senses: "Passive Perception 14",
    languages: "Giant Eagle, understands Common, Auran",
    traits: ["Keen Sight."],
    actions: [
      "Multiattack (beak + talons).",
      "Beak: +5 to hit, 5 ft., 1d6+3 piercing.",
      "Talons: +5 to hit, 5 ft., 2d6+3 slashing.",
    ],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  ...
  },
  {
    ...
    actions: ["Life Drain: +4 to hit, 5 ft., 3d6 necrotic."],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  {
  ...
  },
  {
    ...
    senses: "Passive Perception 10",
    languages: "Any two languages",
    traits: ["Parry: +2 AC vs one melee attack."],
    actions: [
      "Multiattack (three attacks: scimitar or dagger).",
      "Scimitar: +5 to hit, 5 ft., 1d6+3 slashing.",
      "Dagger: +5 to hit, 5 ft. or 20/60 ft., 1d4+3 piercing.",
    ],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  ...
  },
  {
    ...
    actions: ["Pseudopod: +4 to hit, 5 ft., 3d6+2 bludgeoning plus acid."],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  {
    ...
    speed: "30 ft.",
    challenge: "2",
    abilities: { str: 16, dex: 14, con: 10, int: 11, wis: 10, cha: 8 },
    senses: "Darkvision 60 ft.",
    languages: "Common",
    traits: ["Stench.", "Turn Defiance."],
    actions: ["Multiattack (bite + claws)."],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  ...
  },
  {
    ...
    senses: "Blindsight 60 ft. (blind beyond), Passive Perception 8",
    languages: "--",
    traits: ["Amorphous.", "Spider Climb.", "Split."],
    actions: ["Pseudopod: +4 to hit, 5 ft., 2d6+2 bludgeoning plus 1d6 acid."],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  {
  ...
  },
  {
    ...
    languages: "Any two languages",
    traits: [
      "Divine Eminence: add 1d8 radiant to weapon hit.",
      "Spellcasting (cleric): spell save DC 13, +5 to hit.",
    ],
    actions: ["Mace: +2 to hit, 5 ft., 1d6 bludgeoning."],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  {
    ...
    actions: [
      ...
      "Greatsword: +5 to hit, 5 ft., 2d6+3 slashing.",
      "Heavy Crossbow: +3 to hit, 100/400 ft., 1d10+1 piercing.",
    ],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  ...
  },
  {
    ...
    actions: ["Life Drain: +6 to hit, 5 ft., 4d8+3 necrotic."],
    source: "SRD",
    visual: { fallback: "initials" },
  },
  {
